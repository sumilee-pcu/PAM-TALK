...
function MarketplacePage() {
  ...
  const bannerSlides = [
    {
      id: 1,
      image: '/images/banners/fruits.svg',
      title: '신선한 제철 과일',
    ...
    {
      id: 2,
      image: '/images/banners/vegetables.svg',
      title: '유기농 채소 특가',
      subtitle: '건강한 밥상의 시작',
    ...
    {
      id: 3,
      image: '/images/banners/market.svg',
      title: '이달의 신선 상품',
  ...
  function generateEnhancedProducts() {
    const productData = [
      // 채소류
      { name: '완숙 토마토', category: '채소', image: '/images/products/tomato.svg', price: 3500, cert: '유기농', carbon: 0.8, desc: '당도 높은 완숙 토마토', badge: 'best' },
      { name: '싱싱 오이', category: '채소', image: '/images/products/cucumber.svg', price: 2500, cert: '무농약', carbon: 0.6, desc: '아삭아삭 신선한 오이' },
      { name: '포기 배추', category: '채소', image: '/images/products/cabbage.svg', price: 4000, cert: '친환경', carbon: 1.2, desc: '김장용 배추', badge: 'new' },
      { name: '청상추', category: '채소', image: '/images/products/lettuce.svg', price: 2000, cert: '유기농', carbon: 0.4, desc: '부드러운 청상추' },
      { name: '시금치', category: '채소', image: '/images/products/spinach.svg', price: 2800, cert: '무농약', carbon: 0.5, desc: '영양 가득 시금치' },
      { name: '당근', category: '채소', image: '/images/products/carrot.svg', price: 3000, cert: '친환경', carbon: 0.7, desc: '달콤한 당근', badge: 'best' },
      { name: '무', category: '채소', image: '/images/products/radish.svg', price: 2500, cert: '유기농', carbon: 0.9, desc: '아삭한 무' },
      { name: '애호박', category: '채소', image: '/images/products/zucchini.svg', price: 2200, cert: '무농약', carbon: 0.6, desc: '신선한 애호박' },
      { name: '청양고추', category: '채소', image: '/images/products/pepper.svg', price: 4500, cert: '친환경', carbon: 0.5, desc: '매운 청양고추', badge: 'hot' },
      { name: '대파', category: '채소', image: '/images/products/onion.svg', price: 1800, cert: '유기농', carbon: 0.4, desc: '향긋한 대파' },

      // 과일류
      { name: '사과(부사)', category: '과일', image: '/images/products/apple.svg', price: 5000, cert: '유기농', carbon: 1.5, desc: '달콤한 부사 사과', badge: 'best' },
      { name: '배(신고배)', category: '과일', image: '/images/products/pear.svg', price: 6000, cert: '친환경', carbon: 1.4, desc: '즙이 풍부한 신고배' },
      { name: '딸기', category: '과일', image: '/images/products/strawberry.svg', price: 8000, cert: '유기농', carbon: 1.8, desc: '당도 높은 딸기', badge: 'new' },
      { name: '포도(샤인머스캣)', category: '과일', image: '/images/products/grape.svg', price: 12000, cert: '무농약', carbon: 2.0, desc: '프리미엄 샤인머스캣', badge: 'premium' },
      { name: '복숭아', category: '과일', image: '/images/products/peach.svg', price: 7000, cert: '친환경', carbon: 1.6, desc: '달콤한 백도 복숭아' },
      { name: '감(단감)', category: '과일', image: '/images/products/persimmon.svg', price: 4500, cert: '유기농', carbon: 1.3, desc: '아삭한 단감', badge: 'best' },
      { name: '귤(제주)', category: '과일', image: '/images/products/tangerine.svg', price: 3500, cert: '친환경', carbon: 1.2, desc: '제주 노지 귤' },
      { name: '수박', category: '과일', image: '/images/products/watermelon.svg', price: 15000, cert: '무농약', carbon: 2.5, desc: '당도 높은 수박' },
      { name: '참외', category: '과일', image: '/images/products/melon.svg', price: 4000, cert: '친환경', carbon: 1.1, desc: '달콤한 성주 참외' },
      { name: '블루베리', category: '과일', image: '/images/products/blueberry.svg', price: 9000, cert: '유기농', carbon: 1.7, desc: '생과 블루베리', badge: 'new' },

      // 곡물/쌀
      { name: '백미(10kg)', category: '곡물/쌀', image: '/images/products/rice.svg', price: 35000, cert: '무농약', carbon: 3.5, desc: '찰진 백미' },
      { name: '현미(10kg)', category: '곡물/쌀', image: '/images/products/brownrice.svg', price: 40000, cert: '유기농', carbon: 3.8, desc: '영양 가득 현미', badge: 'best' },
      { name: '찹쌀(5kg)', category: '곡물/쌀', image: '/images/products/stickyrice.svg', price: 25000, cert: '친환경', carbon: 2.5, desc: '고소한 찹쌀' },
      { name: '보리쌀(2kg)', category: '곡물/쌀', image: '/images/products/barley.svg', price: 12000, cert: '무농약', carbon: 1.8, desc: '건강한 보리쌀' },
      { name: '귀리(1kg)', category: '곡물/쌀', image: '/images/products/oat.svg', price: 8000, cert: '유기농', carbon: 1.2, desc: '다이어트 귀리' },
      { name: '서리태(1kg)', category: '곡물/쌀', image: '/images/products/bean.svg', price: 15000, cert: '친환경', carbon: 1.5, desc: '영양 가득 서리태', badge: 'best' },

      // 축산물
      { name: '한우 등심', category: '축산물', image: '/images/products/beef.svg', price: 45000, cert: '1++등급', carbon: 15.0, desc: '프리미엄 한우', badge: 'premium' },
      { name: '한우 불고기', category: '축산물', image: '/images/products/bulgogi.svg', price: 28000, cert: '1+등급', carbon: 12.0, desc: '부드러운 불고기용', badge: 'best' },
      { name: '돼지고기 삼겹살', category: '축산물', image: '/images/products/pork.svg', price: 18000, cert: '1등급', carbon: 8.5, desc: '두툼한 삼겹살' },
      { name: '닭고기(백숙용)', category: '축산물', image: '/images/products/chicken.svg', price: 12000, cert: '무항생제', carbon: 4.2, desc: '신선한 백숙용 닭' },
      { name: '오리고기', category: '축산물', image: '/images/products/duck.svg', price: 15000, cert: '친환경', carbon: 5.5, desc: '훈제 오리고기' },
      { name: '유정란(30입)', category: '축산물', image: '/images/products/egg.svg', price: 8000, cert: '동물복지', carbon: 2.8, desc: '고급 유정란', badge: 'best' },
      { name: '우유(1L)', category: '축산물', image: '/images/products/milk.svg', price: 3500, cert: '유기농', carbon: 2.5, desc: '목장 신선 우유' },

      // 수산물
      { name: '고등어', category: '수산물', image: '/images/products/mackerel.svg', price: 8000, cert: '국내산', carbon: 3.2, desc: '생 고등어', badge: 'new' },
      { name: '갈치', category: '수산물', image: '/images/products/hairtail.svg', price: 25000, cert: '국내산', carbon: 3.8, desc: '제주 은갈치', badge: 'premium' },
      { name: '조기', category: '수산물', image: '/images/products/croaker.svg', price: 18000, cert: '국내산', carbon: 3.5, desc: '황금 조기' },
      { name: '오징어', category: '수산물', image: '/images/products/squid.svg', price: 12000, cert: '국내산', carbon: 2.8, desc: '통통한 오징어' },
      { name: '새우(왕새우)', category: '수산물', image: '/images/products/shrimp.svg', price: 22000, cert: '국내산', carbon: 4.5, desc: '싱싱한 왕새우', badge: 'best' },
      { name: '낙지', category: '수산물', image: '/images/products/octopus.svg', price: 28000, cert: '국내산', carbon: 3.0, desc: '연평도 낙지' },
      { name: '멸치(볶음용)', category: '수산물', image: '/images/products/anchovy.svg', price: 15000, cert: '국내산', carbon: 2.2, desc: '남해안 멸치' },
      { name: '김(재래김)', category: '수산물', image: '/images/products/seaweed.svg', price: 12000, cert: '유기농', carbon: 1.5, desc: '완도 재래김', badge: 'best' },

      // 가공식품
      { name: '전통 된장(1kg)', category: '가공식품', image: '/images/products/doenjang.svg', price: 15000, cert: '전통식품', carbon: 2.0, desc: '3년 숙성 된장', badge: 'best' },
      { name: '고추장(500g)', category: '가공식품', image: '/images/products/gochujang.svg', price: 12000, cert: '전통식품', carbon: 1.8, desc: '매콤한 고추장' },
      { name: '국간장(1L)', category: '가공식품', image: '/images/products/soysauce.svg', price: 18000, cert: '전통식품', carbon: 2.5, desc: '천연 국간장' },
      { name: '포기김치(2kg)', category: '가공식품', image: '/images/products/kimchi.svg', price: 22000, cert: '전통식품', carbon: 3.2, desc: '맛있는 배추김치', badge: 'hot' },
      { name: '깍두기(1kg)', category: '가공식품', image: '/images/products/kkakdugi.svg', price: 12000, cert: '전통식품', carbon: 2.0, desc: '아삭한 깍두기' },
      { name: '오이소박이(500g)', category: '가공식품', image: '/images/products/pickle.svg', price: 8000, cert: '전통식품', carbon: 1.5, desc: '새콤달콤 오이소박이' },

      // 건강식품
      { name: '6년근 홍삼', category: '건강식품', image: '/images/products/ginseng.svg', price: 85000, cert: '건강기능식품', carbon: 3.5, desc: '프리미엄 홍삼', badge: 'premium' },
      { name: '아카시아 꿀(1kg)', category: '건강식품', image: '/images/products/honey.svg', price: 35000, cert: '유기농', carbon: 2.8, desc: '순수 벌꿀', badge: 'best' },
      { name: '제주 녹차', category: '건강식품', image: '/images/products/greentea.svg', price: 18000, cert: '유기농', carbon: 1.2, desc: '제주 유기농 녹차' },
      { name: '쌍화차(20포)', category: '건강식품', image: '/images/products/herbaltea.svg', price: 15000, cert: '한방식품', carbon: 1.5, desc: '건강한 쌍화차' },
      { name: '매실효소(1L)', category: '건강식품', image: '/images/products/plum.svg', price: 22000, cert: '전통식품', carbon: 2.2, desc: '3년 숙성 매실효소' },
      { name: '청국장(500g)', category: '건강식품', image: '/images/products/fermented.svg', price: 12000, cert: '전통식품', carbon: 1.8, desc: '발효 청국장', badge: 'best' },

      // 생활용품
      { name: '친환경 수세미', category: '생활용품', image: '/images/products/sponge.svg', price: 3000, cert: '친환경', carbon: 0.5, desc: '천연 수세미' },
      { name: '천연 비누', category: '생활용품', image: '/images/products/soap.svg', price: 5000, cert: '천연', carbon: 0.8, desc: '수제 천연비누' },
      { name: '친환경 세제(1L)', category: '생활용품', image: '/images/products/detergent.svg', price: 8000, cert: '친환경', carbon: 1.2, desc: '환경 세탁세제' },
      { name: '대나무 칫솔', category: '생활용품', image: '/images/products/toothbrush.svg', price: 4000, cert: '친환경', carbon: 0.3, desc: '대나무 칫솔 3개' }
    ];

    const farmers = [
      { name: '김철수', location: '충남 아산시', photo: '/images/farmers/farmer1.svg' },
      { name: '이영희', location: '경기 용인시', photo: '/images/farmers/farmer2.svg' },
      { name: '박민수', location: '강원 춘천시', photo: '/images/farmers/farmer3.svg' },
      { name: '정수연', location: '전북 완주군', photo: '/images/farmers/farmer4.svg' },
      { name: '최동욱', location: '경남 김해시', photo: '/images/farmers/farmer5.svg' },
      { name: '강미래', location: '제주시', photo: '/images/farmers/farmer6.svg' },
      { name: '윤준호', location: '충북 청주시', photo: '/images/farmers/farmer7.svg' },
      { name: '한지우', location: '전남 완도군', photo: '/images/farmers/farmer8.svg' }
    ];
